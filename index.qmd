...
Ce document interactif vous permet d'utiliser notre modèle de prédiction de churn. Remplissez les informations du client ci-dessous pour savoir s'il est susceptible de quitter la banque.
